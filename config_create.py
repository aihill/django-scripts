...
CONFIG_TEMPLATE = os.path.join(DIR, 'templates', 'config_template.sh')
...
# PSQL_VERSION defaults
if os.path.exists('/etc/os-release'):
    for line in open('/etc/os-release').readlines():
        line = line.strip()
        if line == 'VERSION_ID="12.04"':
            variables['PSQL_VERSION'] = '9.1'
            break
        elif line == 'VERSION_ID="14.04"':
            variables['PSQL_VERSION'] = '9.3'
            break
